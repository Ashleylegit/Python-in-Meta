...
my_int = 45
 # Part 1 numbers greater than 45

for number in num_list:
    
     print(num_list[16] > my_int)

# Part 2 create a condition that will look for all numbers that are 
# greater than 45 and print out only numbers that 
# meet that condition
     new_list = [y for y in num_list if y > 45]

     print('over 45:', new_list)

# Part 3 (change statement to over 45 and add else)    
if num_list 
print()
